...
function Appearance() {
  ...
  const [ircMode, setIrcMode] = useSetting(settingsAtom, 'ircMode');
  ...
  return (
    <Box direction="Column" gap="100">
      ...
      <SequenceCard className={SequenceCardStyle} variant="SurfaceVariant" direction="Column">
        <SettingTile
          title="IRC-style layout"
          description="Narrower sidebar and room list with compact, IRC-like chat list items."
          after={<Switch variant="Primary" value={ircMode} onChange={setIrcMode} />}
        />
      </SequenceCard>
    </Box>
  );
