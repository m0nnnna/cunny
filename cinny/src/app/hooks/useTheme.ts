...
import { butterTheme, darkTheme, nekoDarkTheme, nekoLightTheme, silverTheme } from '../../colors.css';
...
export const useThemes = (): Theme[] => {
  const themes: Theme[] = useMemo(
    () => [LightTheme, SilverTheme, DarkTheme, ButterTheme, NekoLightTheme, NekoDarkTheme],
    []
  );
