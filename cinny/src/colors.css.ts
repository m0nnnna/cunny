...
export const nekoKawaiiTheme = createTheme(color, {
  Background: {
    Container: 'rgba(255, 240, 248, 0.58)',
    ContainerHover: 'rgba(219, 112, 147, 0.12)',
    ContainerActive: 'rgba(219, 112, 147, 0.22)',
    ContainerLine: 'rgba(219, 112, 147, 0.20)',
    OnContainer: '#4a2c3a',
  },

  Surface: {
    Container: 'rgba(255, 250, 253, 0.52)',
    ContainerHover: 'rgba(219, 112, 147, 0.09)',
    ContainerActive: 'rgba(219, 112, 147, 0.18)',
    ContainerLine: 'rgba(219, 112, 147, 0.16)',
    OnContainer: '#4a2c3a',
  },

  SurfaceVariant: {
    Container: 'rgba(255, 228, 240, 0.56)',
    ContainerHover: 'rgba(219, 112, 147, 0.08)',
    ContainerActive: 'rgba(219, 112, 147, 0.15)',
    ContainerLine: 'rgba(219, 112, 147, 0.14)',
    OnContainer: '#4a2c3a',
  },
  ...
  Primary: {
    ...
    MainLine: '#f9d0de',
    OnMain: '#ffffff',
    Container: 'rgba(244, 114, 182, 0.22)',
    ContainerHover: 'rgba(244, 114, 182, 0.34)',
    ContainerActive: 'rgba(244, 114, 182, 0.46)',
    ContainerLine: 'rgba(219, 112, 147, 0.50)',
    OnContainer: '#5c1a3a',
  },
  ...
  Secondary: {
    ...
    MainLine: '#e388a8',
    OnMain: '#fff0f5',
    Container: 'rgba(255, 182, 210, 0.22)',
    ContainerHover: 'rgba(255, 182, 210, 0.34)',
    ContainerActive: 'rgba(255, 182, 210, 0.46)',
    ContainerLine: 'rgba(255, 182, 210, 0.50)',
    OnContainer: '#4a2535',
  },
  ...
  Other: {
    FocusRing: 'rgba(219, 112, 147, 0.45)',
    Shadow: 'rgba(180, 100, 140, 0.12)',
    Overlay: 'rgba(100, 50, 75, 0.38)',
  },
});
